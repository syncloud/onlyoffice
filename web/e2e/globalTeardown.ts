...
const TMP_DIR = '/tmp/syncloud/oo-ui'
...
export default async function () {
  ...
  ssh(`cp /var/snap/onlyoffice/current/config/nginx.conf ${TMP_DIR}/nginx.conf.log`, { throw: false })
  ssh(`ls -la /data/onlyoffice/files > ${TMP_DIR}/files.ls.log`, { throw: false })
