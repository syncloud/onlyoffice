...
test.describe('round-trip: docx', () => {
  test('type, autosave, reopen, content survives', async ({ page }, testInfo) => {
    ...
    const phrase = 'HelloRoundtripDocx'
    await page.keyboard.type(phrase, { delay: 30 })
    await page.waitForTimeout(2000)
    await shoot(page, testInfo, 'roundtrip-docx-edit')
    ...
    await waitEditorRendered(page)
    await shoot(page, testInfo, 'roundtrip-docx-reopen')
